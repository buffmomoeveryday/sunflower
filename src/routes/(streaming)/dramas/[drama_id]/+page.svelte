...
>
    ...
    {:else}
        ...
        <div class="w-24 h-14 rounded flex-shrink-0 bg-gray-700 flex items-center justify-center"> <!-- Increased width (w-24) and height (h-14) -->
    ...
    {#if selectedEpisode === index + 1}
        <Play size={18} class="flex-shrink-0 self-center" /> <!-- Slightly larger play icon -->
    {/if}
</button>
