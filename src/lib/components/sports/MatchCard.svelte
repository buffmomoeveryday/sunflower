...
<div class="group relative overflow-hidden bg-gray-900/80 backdrop-blur-sm rounded-2xl shadow-lg transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/20 hover:-translate-y-2 border border-gray-800/50">
    <a href="/sports/streams/{match.id}" class="block text-white no-underline">
        <!-- Match poster placeholder or fallback icon -->
        <div class="relative w-full aspect-[2/3] overflow-hidden">
            <div class="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-blue-600 to-purple-700 group-hover:from-blue-700 group-hover:to-purple-800 transition-colors duration-300">
        ...
        <div class="p-4 space-y-2">
            <h3 class="text-white font-semibold text-base leading-tight line-clamp-1 group-hover:text-blue-400 transition-colors duration-300">
                {match.title}
            </h3>
