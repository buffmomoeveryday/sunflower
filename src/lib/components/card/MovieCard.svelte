<script>
 ...
 <div
 	...
 	onmouseleave={() => {
 		// Keep the background image persistent
 	}}
 >
 	<div
 		class="relative overflow-hidden bg-gray-900/80 backdrop-blur-sm rounded-2xl shadow-lg transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/20 hover:-translate-y-2 border border-gray-800/50 h-full flex flex-col"
 	>
 		<div class="text-white no-underline flex flex-col h-full">
 			...
 			<div
 				...
 				class="relative w-full aspect-[2/3] overflow-hidden flex-shrink-0"
 			>
 				<img
			...
			<div class="p-3 sm:p-4 flex flex-col flex-1 justify-between gap-2 sm:gap-3">
				<div class="space-y-2 sm:space-y-3">
					<h3
						class="text-white font-semibold text-sm sm:text-base leading-tight line-clamp-2 min-h-[2.5rem] group-hover:text-blue-400 transition-colors duration-300"
					>
						{title}
					</h3>
				...
				<div class="flex gap-2">
					<button
						type="button"
						class="flex-1 bg-pink-500 hover:bg-pink-700 text-white text-xs sm:text-sm font-semibold py-1.5 sm:py-2 px-3 sm:px-4 rounded-xl shadow-md transition-colors duration-300"
