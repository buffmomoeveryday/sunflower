...
<div class="flex flex-col min-h-screen text-white bg-black">
    ...
    <section class="flex-1 flex flex-col p-4 md:p-6 min-h-0">
        ...
        <div class="relative w-full aspect-video mb-4"> <!-- This enforces 16:9 -->
            <div class="absolute inset-0 bg-gray-900 border-2 border-gray-700 rounded-lg shadow-lg overflow-hidden">
                <iframe
    ...
    <section class="p-4 md:p-6 space-y-6 overflow-y-auto flex-shrink-0 max-h-[35vh] no-scrollbar"> <!-- Adjust max-h as needed -->
