<script>
    // Assuming you receive episode_count as a prop now
        ...
        <a href="/anime/{id}" class="block text-white no-underline">
            ...
            <div class="relative w-full aspect-[2/3] overflow-hidden">
                ...
                <div class="absolute top-3 right-3 z-10">
                    <div class="flex items-center justify-center min-w-[48px] h-8 px-2 {ratingColor} rounded-full shadow-lg backdrop-blur-sm">
                    ...
                    {#if year}
                        <span class="flex items-center gap-1">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 2 0 002-2V7a2 2 2 0 00-2-2H5a2 2 2 0 00-2 2v12a2 2 2 0 002 2z"/>
                            </svg>
                            {year}
                        </span>
                    {/if}
